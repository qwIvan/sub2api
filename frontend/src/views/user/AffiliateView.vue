            ...
            <table class="w-full min-w-[560px] text-left text-sm">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="px-3 py-3 text-right font-medium text-emerald-600 dark:text-emerald-400">{{ formatCurrency(item.total_rebate, 'CNY') }}</td>
...
async function transferQuota(): Promise<void> {
  ...
  try {
    ...
    appStore.showSuccess(t('affiliate.transfer.success', { amount: formatCurrency(resp.transferred_quota, 'CNY') }))
    await Promise.all([
